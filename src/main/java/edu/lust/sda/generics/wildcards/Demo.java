package edu.lust.sda.generics.wildcards;
...
public class Demo {
    public static void main(String[] args) {
        ...
        Picture picture1 = new Picture(new Note("Pamiątka znad morza"),image1);
        Picture picture2 = new Picture(new Note("Pamiątka z gór"),image2);
        ...
        /**
         * Wywołanie printAllMemories dla picturesOnly nie zadziała bo JVM spodziewa się listy
         * List<Memento> a dostaje List<Picture>
         *     i mimo że Picture jest klasą pochodną od Memento to nie umie tego obsłużyć bo List<Picture> nie jest
         *     klasą pochodną od List</Memento>
         *
         *     czyli nawet jak klasa B rozszerza klasę A
         *     to Kolekcja(B) nie rozszerza Kolejkcji(A)
         *
